...
parser.add_argument("--latent_dim", type=int, default=1, help="dimentionality of latent space")
...
#Intialize Discriminator and Generator
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        # LOss measures generator ability to fool discriminator
        g_loss = adversarial_loss(discriminator(gen_imgs), z)
        ...
        #Measure discriminators ability to classify real from generated samples
